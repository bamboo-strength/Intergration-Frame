...
export function checkValidate(componentName: any, value: any, propName: any, valueFormat: any) {
...
export const stringToMoment = (value: any, valueFormat: any) => {
  if (Array.isArray(value)) {
...
export const momentToString = (value: any, valueFormat: any) => {
  if (Array.isArray(value)) {
